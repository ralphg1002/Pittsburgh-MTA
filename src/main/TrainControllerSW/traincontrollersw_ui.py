...
class MainWindow(QMainWindow):
    ...
    tcEmergencyBrake = 0
    tcServiceBrake = 0
    tcSetpointCommand = 25
    tcAnnouncement = "Stand Clear of the Closing Doors"
    tcLeftDoor = 0
    tcRightDoor = 0
    tcExternalLights = 0
    tcInternalLights = 1
    ...
    def __init__(self):
        ...
        self.homeBackground.setStyleSheet(
            "background-color: #9FC5F8; " "border: 5px solid black"
        )
        ...
        self.pixmapCat = QtGui.QPixmap("src/main/TrainControllerSW/homecat.png")
        ...
        self.traincontrollerswButton.setStyleSheet(
        ...
        self.pixmapLogo = QtGui.QPixmap(
            "src/main/TrainControllerSW/MTA_NYC_logo.svg.png"
        )
        ...
        self.background.setStyleSheet(
            "background-color: #2B78E4; " "border: 1px solid black"
        )
        ...
        self.pixmap = QtGui.QPixmap("src/main/TrainControllerSW/chevrons-up.svg")
        ...
        self.wireframeButton.setStyleSheet(
            "QPushButton{background-color: white; "
            "color: #085394; "
        ...
        self.wireframeButton.clicked.connect(self.ui_wireframe)
        ...
        self.rightChevron1.setStyleSheet(
            "QPushButton{background-color: white; "
            "color: #085394; "
            "border: 1px solid #085394; "
            "border-radius: 24px}"
            "QPushButton::pressed{background-color: #9FC5F8; "
            "color: #085394; "
            "border: 1px solid #085394; "
            "border-radius: 24px}"
        )
        ...
        self.rightChevron2.setStyleSheet(
            "QPushButton{background-color: white; "
            "color: #085394; "
            "border: 1px solid #085394; "
            "border-radius: 24px}"
            "QPushButton::pressed{background-color: #9FC5F8; "
            "color: #085394; border: 1px solid #085394; "
            "border-radius: 24px}"
        )
        self.rightChevron2.clicked.connect(self.ui_wireframe)

        self.homepageWidgets = [
            self.enterTrainID,
            self.rightChevron1,
        ...
        self.changeTrainLabel.setStyleSheet(
            "QPushButton{background-color: #085394; "
            "color: white; "
            "border: 1px solid #085394}"
            "QPushButton::pressed{background-color: #9FC5F8; "
            "color: white; "
        ...
        self.systemSpeedLabel.setStyleSheet(
            "background-color: #CCCCCC; " "color: #085394"
        )

        self.systemValidator = QDoubleValidator(0, 3, 2)

        self.systemSpeedVal = QLineEdit(self)
        self.systemSpeedVal.setText(str(self.systemBaseSpeed))
        self.systemSpeedVal.setGeometry(1177, 685, 50, 32)
        self.systemSpeedVal.setFont(QFont("Calibri", 9))
        self.systemSpeedVal.setStyleSheet("background-color: #CCCCCC; " "color: black")
        self.systemSpeedVal.setValidator(self.systemValidator)
        self.systemSpeedVal.setReadOnly(True)
        ...
        self.fastforward.setStyleSheet(
        ...
        self.rewind.setStyleSheet(
            "QPushButton{background-color: #CCCCCC}"
            "QPushButton::pressed{background-color: #CCCCCC; "
            "border: 1px solid #274E13}"
        )
        self.rewind.clicked.connect(self.system_slow_down)
        ...
        self.suggestedSpeedLabel.setStyleSheet(
            "background-color: black; " "color: #9FC5F8"
        )
        ...
        self.suggestedSpeedVal.setStyleSheet(
            "background-color: black; " "color: #9FC5F8"
        )
        ...
        self.authorityUnitLabel.setStyleSheet(
        ...
        self.warningHeader.setStyleSheet(
            "background-color: #CF2A27; " "color: white; " "border: 1px solid #CF2A27"
        )

        self.warningBody = QLabel(self)
        self.warningBody.setGeometry(1202, 410, 281, 265)
        self.warningBody.setStyleSheet(
            "background-color: #EA9999; " "border: 1px solid #CF2A27"
        )
        ...
        self.signalPickupFailureLabel.setStyleSheet(
            "background-color: #EA9999; " "color: white"
        )
        ...
        self.trainEngineFailureLabel.setStyleSheet(
            "background-color: #EA9999; " "color: white"
        )
        ...
        self.brakeFailureLabel.setStyleSheet(
            "background-color: #EA9999; " "color: white"
        )
        ...
        self.whiteRectangle4.setStyleSheet(
        ...
        self.nextStopIcon.setStyleSheet(
            "background-color: white; "
            "border: 10px solid #EA9999; "
            "border-radius: 30"
        )
        ...
        self.trainIcon.setStyleSheet(
            "background-color: white; "
            "border: 10px solid #9FC5F8; "
            "border-radius: 30"
        )
        ...
        self.previousStopIcon.setStyleSheet(
            "background-color: white; "
            "border: 10px solid #9FC5F8; "
            "border-radius: 30"
        )

        self.displayLayoutWidgets = [
            self.blueVerticalLine2,
        ...
        self.kpLabel.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.emergencyBrakeLabel.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.emergencyBrakeButton.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.serviceBrakeLabel.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.serviceBrakeButton.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.setpointSpeedLabel.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.setpointSpeedVal.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.announcements.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.chevronsDown1.setStyleSheet(
            "QPushButton{background-color: white; "
            "color: #085394; "
            "border: 1px solid #085394; "
            "border-radius: 24px}"
        ...
        self.chevronsUp1.setStyleSheet(
            "QPushButton{background-color: white; "
            "color: #085394; border: 1px solid #085394; "
            "border-radius: 24px}"
            "QPushButton::pressed{background-color: #9FC5F8; "
        ...
        self.doorLeftButton.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.doorRightButton.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.externalLightsLabel.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.externalLightsButton.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.internalLightsLabel.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.internalLightsButton.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.setpointTempLabel.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.setpointTempVal.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.advertisementLabel.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.largeRectangle1.setStyleSheet(
            "background-color: white; " "border: 5px solid #2B78E4"
        )

        self.largeRectangle2 = QLabel(self)
        self.largeRectangle2.setGeometry(1058, 303, 401, 678)
        self.largeRectangle2.setStyleSheet(
            "background-color: #CCCCCC; " "border: 5px solid #CF2A27"
        )
        ...
        self.resultButton.setStyleSheet(
            ...
            "border: 1px solid #085394; "
            "border-radius: 64px}"
            "QPushButton::pressed{background-color: #2B78E4; "
            "color: #085394; "
            "border: 1px solid white; "
            "border-radius: 64px}"
        )
        ...
        self.trainInputVal.setText("TEST")
        self.trainInputVal.setAlignment(Qt.AlignCenter)
        self.trainInputVal.setStyleSheet(
            "background-color: white; " "color: #2B78E4; " "border: 1px solid #2B78E4"
        )
        ...
        self.testbenchSpeedLimitLabel.setStyleSheet(
            "background-color: white; " "color: #085394"
        )
        ...
        self.testbenchSpeedLimitVal.setText("30")
        self.testbenchSpeedLimitVal.setAlignment(Qt.AlignCenter)
        self.testbenchSpeedLimitVal.setStyleSheet(
            "background-color: white; " "color: #2B78E4; " "border: 1px solid #2B78E4"
        )
        ...
        self.testbenchAuthorityLabel.setStyleSheet(
            "background-color: white; " "color: #085394"
        )

        self.testbenchAuthorityVal = QLineEdit(self)
        self.testbenchAuthorityVal.setGeometry(615, 480, 60, 33)
        self.testbenchAuthorityVal.setText("10")
        self.testbenchAuthorityVal.setAlignment(Qt.AlignCenter)
        self.testbenchAuthorityVal.setFont(QFont("Calibri", 8))

        self.testbenchAuthorityVal.setStyleSheet(
            "background-color: white; " "color: #2B78E4; " "border: 1px solid #2B78E4"
        )
        ...
        self.testbenchCurrentSpeedLabel.setStyleSheet(
            "background-color: white; " "color: #085394"
        )
        ...
        self.testbenchCurrentSpeedVal.setText("26")
        self.testbenchCurrentSpeedVal.setAlignment(Qt.AlignCenter)
        self.testbenchCurrentSpeedVal.setStyleSheet(
            "background-color: white; " "color: #2B78E4; " "border: 1px solid #2B78E4"
        )
        ...
        self.testbenchCommandedSpeedLabel.setStyleSheet(
            "background-color: white; " "color: #085394"
        )
        ...
        self.testbenchCommandedSpeedVal.setText("30")
        self.testbenchCommandedSpeedVal.setAlignment(Qt.AlignCenter)
        self.testbenchCommandedSpeedVal.setStyleSheet(
            "background-color: white; " "color: #2B78E4; " "border: 1px solid #2B78E4"
        )
        self.testbenchCommandedSpeedVal.returnPressed.connect(
            self.input_tm_commanded_speed
        )
        ...
        self.testbenchBeaconLabel.setStyleSheet(
            "background-color: white; " "color: #085394"
        )
        ...
        self.testbenchBeaconButton.setStyleSheet(
            "QPushButton{background-color: white; "
            "color: #085394; "
            "border: 1px solid #085394}"
            "QPushButton::pressed{background-color: #9FC5F8; "
        ...
        self.testbenchTempLabel.setStyleSheet(
            "background-color: white; " "color: #085394"
        )
        ...
        self.testbenchTempVal.setText("40")
        self.testbenchTempVal.setAlignment(Qt.AlignCenter)
        self.testbenchTempVal.setStyleSheet(
            "background-color: white; " "color: #2B78E4; " "border: 1px solid #2B78E4"
        )
        ...
        self.passengerInputLabel.setStyleSheet(
            "background-color: white; " "color: #2B78E4"
        )
        ...
        self.testbenchEmergencyBrakeLabel.setStyleSheet(
            "background-color: white; " "color: #085394"
        )
        ...
        self.testbenchEmergencyBrakeButton.setStyleSheet(
            "QPushButton{background-color: white; "
            "color: #085394; "
            "border: 1px solid #085394}"
            "QPushButton::pressed{background-color: #9FC5F8; "
        ...
        self.testbenchEmergencyBrakeButton.clicked.connect(
            self.input_tm_emergency_brake
        )
        ...
        self.murphyInputLabel.setStyleSheet(
            "background-color: white; " "color: #2B78E4"
        )
        ...
        self.testbenchSignalFailLabel.setStyleSheet(
            "background-color: white; " "color: #085394"
        )
        ...
        self.testbenchSignalFailButton.setStyleSheet(
            "QPushButton{background-color: white; "
            "color: #085394; "
            "border: 1px solid #085394}"
            "QPushButton::pressed{background-color: #9FC5F8; "
        ...
        self.testbenchEngineFailLabel.setStyleSheet(
            "background-color: white; " "color: #085394"
        )
        ...
        self.testbenchEngineFailButton.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.testbenchBrakeFailLabel.setStyleSheet(
            "background-color: white; " "color: #085394"
        )
        ...
        self.testbenchBrakeFailButton.setStyleSheet(
            "background-color: white; " "color: #085394; " "border: 1px solid #085394"
        )
        ...
        self.testbenchPowerCommandLabel.setStyleSheet(
        ...
        self.testbenchPowerCommandVal.setText("--")
        self.testbenchPowerCommandVal.setAlignment(Qt.AlignCenter)
        self.testbenchPowerCommandVal.setStyleSheet(
            "background-color: #666666; " "color: white; " "border: 1px solid black"
        )
        ...
        self.testbenchSetpointCommandLabel.setStyleSheet(
            "background-color: #CCCCCC; " "color: black"
        )
        ...
        self.testbenchSetpointCommandVal.setText("--")
        self.testbenchSetpointCommandVal.setAlignment(Qt.AlignCenter)
        self.testbenchSetpointCommandVal.setStyleSheet(
            "background-color: #666666; " "color: white; " "border: 1px solid black"
        )
        ...
        self.testbenchAnnouncementLabel.setStyleSheet(
            "background-color: #CCCCCC; " "color: black"
        )
        ...
        self.testbenchAnnouncementVal.setText("--")
        self.testbenchAnnouncementVal.setAlignment(Qt.AlignCenter)
        self.testbenchAnnouncementVal.setStyleSheet(
            "background-color: #666666; " "color: white; " "border: 1px solid black"
        )
        ...
        self.testbenchInternalLightsLabel.setStyleSheet(
            "background-color: #CCCCCC; " "color: black"
        )
        ...
        self.testbenchInternalLightsButton.setText("--")
        self.testbenchInternalLightsButton.setStyleSheet(
        ...
        self.testbenchExternalLightsLabel.setStyleSheet(
            "background-color: #CCCCCC; " "color: black"
        )
        ...
        self.testbenchExternalLightsButton.setText("--")
        self.testbenchExternalLightsButton.setStyleSheet(
            "QPushButton{background-color: #666666; "
            "color: white; "
            "border: 1px solid black}"
            "QPushButton::pressed{background-color: black; "
        ...
        self.testbenchDoorLabel.setStyleSheet(
            "background-color: #CCCCCC; " "color: black"
        )
        ...
        self.testbenchDoorLeft.setText("--")
        self.testbenchDoorLeft.setStyleSheet(
            "QPushButton{background-color: #666666; "
            "color: white; "
            "border: 1px solid black}"
            "QPushButton::pressed{background-color: black; "
        ...
        self.testbenchDoorRight.setText("--")
        self.testbenchDoorRight.setStyleSheet(
            "QPushButton{background-color: #666666; "
            "color: white; "
            "border: 1px solid black}"
            "QPushButton::pressed{background-color: black; "
        ...
        self.testbenchSetpointTempLabel.setStyleSheet(
            "background-color: #CCCCCC; " "color: black"
        )
        ...
        self.testbenchSetpointTempVal.setText("--")
        self.testbenchSetpointTempVal.setAlignment(Qt.AlignCenter)
        self.testbenchSetpointTempVal.setStyleSheet(
            "background-color: #666666; " "color: white; " "border: 1px solid black"
        )
        ...
        self.testbenchAdvertisementLabel.setStyleSheet(
            "background-color: #CCCCCC; " "color: black"
        )
        ...
        self.testbenchAdvertisementButton.setStyleSheet(
            "QPushButton{background-color: #666666; "
            "color: white; "
            "border: 1px solid black}"
            "QPushButton::pressed{background-color: black; "
        ...
        self.testbenchWidgets = [
            self.largeRectangle1,
    ...
    def input_engineer_kp(self):
        ...
        """
        self.uiKP = int(self.kpVal.text())
        print("CHANGED KP TO: " + str(self.uiKP))
    ...
    def input_engineer_ki(self):
        ...
        """
        self.uiKI = int(self.kiVal.text())
        print("CHANGED KI TO: " + str(self.uiKI))
    ...
    def input_driver_manual_mode(self):
        ...
        self.manualButton.setStyleSheet(
            "background-color: #9FC5F8; " "color: #085394; " "border: 1px solid #085394"
        )
    ...
    def input_driver_announcement(self):
        ...
        if self.announcements.currentIndex() == 1:
            ...
            print(
                self.tcAnnouncement + ": This is a _ bound train. The next stop is: _"
            )
    ...
    def input_tm_current_speed(self):
        ...
        """
        self.tmCurrentSpeed = int(self.testbenchCurrentSpeedVal.text())
        self.currentSpeedVal.setText(str(self.tmCurrentSpeed))
        print("EXISTING CURRENT SPEED UPDATED: " + str(self.tmCurrentSpeed))
    ...
    def input_tm_beacon_data(self):
        ...
        """
        file = QFileDialog.getOpenFileName(self, "OPEN")
        if file:
            print("FILE LOCATION: " + str(file))
    ...
    def testbench_button(self):
        ...
        self.tcPowerCommand = (
            1000
            * abs(self.tmCurrentSpeed - self.tcSetpointCommand)
            / self.tmCurrentSpeed
            * (self.uiKP + self.uiKI)
        )
        self.tcPowerCommand = round(self.tcPowerCommand)
        ...
        if self.tcExternalLights == 1:
            ...
            self.testbenchExternalLightsButton.setStyleSheet(
                "background-color: black; " "color: white; " "border: 1px solid #666666"
            )
        else:

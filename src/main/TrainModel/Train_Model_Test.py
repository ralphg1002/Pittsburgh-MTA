...
class TestTrainModel(unittest.TestCase):
    ...
    def test_signal_interior_lights(self):
        train_model_value = TrainModelAttributes()

        trainControllerSWToTrainModel.sendInteriorLightState.emit(True)
    ...
    def test_signal_headlights(self):
        ...
        trainControllerSWToTrainModel.sendHeadlightState.emit(True)
